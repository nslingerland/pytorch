...
def make_test_cls_with_mocked_export(
    cls, cls_prefix, fn_suffix, mocked_export_fn, mocked_private_export_fn, xfail_prop=None
):
    ...
    for name in dir(cls):
        if name.startswith("test_"):
            ...
            new_fn = _make_fn_with_mocked_export(fn, mocked_export_fn, mocked_private_export_fn)
